...
SkiaPaintDevice::SkiaPaintDevice(PdfAuxData &pdfData)
...
SkiaPaintEngine::SkiaPaintEngine(PdfAuxData &pdfData)
...
Font SkiaPaintEngine::qFontToSkia(const QFont &f)
{
